...
INSERT INTO PRODUCT VALUES('SM-18277','1.25-in. metal *****, 25'             ,'2018-03-01',172, 75,  6.99,0.00,21225);
INSERT INTO PRODUCT VALUES('SW-23116','2.5-in. wd. *****, 50'                ,'2018-02-24',237,100,  8.45,0.00,21231);
...
/*View
*/
CREATE VIEW VendorAverageProductCost AS 
SELECT V.V_CODE, V.V_NAME, AVG(P.P_PRICE) AS Ave_Price
FROM VENDOR V JOIN PRODUCT P ON  V.V_CODE = P.V_CODE
GROUP BY V.V_CODE, V.V_NAME;

SELECT *
FROM VendorAverageProductCost
WHERE Ave_Price > 100;
...
/*Query 3
*/
SELECT INVOICE.CUS_CODE, COUNT(DISTINCT INVOICE.INV_NUMBER) AS 'Number of Invoice',
...
SELECT*
FROM PRODUCT P LEFT JOIN LINE L ON P.P_CODE = L.P_CODE
WHERE L.P_CODE IS NULL;
...
/*Query 9
*/
SELECT C.CUS_CODE, C.CUS_FNAME, C.CUS_LNAME
...
HAVING COUNT(DISTINCT P.P_CODE) = (SELECT COUNT(*)
                                    FROM PRODUCT
                                    WHERE V_CODE = 21225);
